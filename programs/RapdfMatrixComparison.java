...
/***
    ...
    Following measures are computed for each pair of atoms separately for each matrix:
...
public class RapdfMatrixComparison{
    ...
    private boolean readRapdfMatrixFromFile(double[][][] rapdfMatrix, String filename)
      {
          ...
          try
          {
             ...
             while ((line = lnr.readLine()) != null)
             {
                 ...
                 {
                   /*** First two tokens are atomOne types ***/
    ...
    private double computeAuxiliaryMatrices(double[][][] rapdfMatrix, double[][][] PDABC, double[] PDAB, double[] NDAB_D)
     ...
     /************************************************************************/
     /***
      Compute distances for each pair of atoms: difference of means, L1, L2 and Linfinity
      ***/
    ...
    /***
     Compute Kullback-Lieber divergencies for distance distributions of every pair of atomOne types
     ***/
    ...
    /***
     Compute mean and variance of distance distributions for each pair of atomOne types
     ***/
    ...
    /***
     Compute resampling for each pair of atomOne types:
    ...
    /***
     Compute Kolmogorov-Smirnov test for each distance distrivution of a pair of atomOne types
     ***/
    ...
    /***
     Compute Mann-Whitney test for each pair of atomOne types
     ***/
    ...
    /***
     Compute observed/expected ration for each distance bin and each pair of atomOne types
     ***/
