        ...
        while (iter.hasNext()) {
            ...
            if ((name1.equals(twoTorsionsParameters.torsion1Name)) &&
                    ...
                    (!(name2.equals("PHI") || name2.equals("PSI") || name2.equals("CHI1")) ||
                            residue.secondaryStructure() == twoTorsionsParameters.secondaryStructure || // Secondary structure exact match
                            residue.secondaryStructure().equalsIgnorOr(twoTorsionsParameters.secondaryStructure))) // XXX_OR_COIL match to COIL
