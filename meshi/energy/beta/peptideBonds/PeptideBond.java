...
public class PeptideBond {
    ...
    public PeptideBond(Atom H, Atom O) {
        ...
        if (!H.type().backboneH()) throw new RuntimeException("Weird peptide bond H atomOne is " + H);
        if (!O.type().backboneO()) throw new RuntimeException("Weird peptide bond O atomOne is " + O);
