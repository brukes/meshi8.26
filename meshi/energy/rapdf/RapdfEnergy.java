...
public class RapdfEnergy extends SimpleEnergyTerm{
    ...
    ***/
    public EnergyInfoElement evaluate() {
     ...
     if (DEBUG_LEVEL>=3)
         System.out.println("+++++++++++++++> Samudrala-Moult score reset "+this.atomList.size()+" atoms is "+energy);
   ...
   /**
    ...
    private void readRapdfMatrixFromDb(MysqlHandler mysql_handler, String tablename)
      {
             if (DEBUG_LEVEL>=1)
              System.out.println("+++++++++++++++> Reading rapdf matrix from db table="+tablename);
             ...
             {
                 System.out.println("+++++++++++++++> Db table="+tablename+" was not found");
                 rapdfMatrix = null;
                 return;
             }
