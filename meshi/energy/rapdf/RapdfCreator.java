...
public class RapdfCreator extends SimpleEnergyCreator  implements KeyWords {
  ...
  public AbstractEnergy createEnergyTerm(Protein protein, DistanceMatrix distanceMatrix,
                 ...
                 System.out.println("Creating RapdfCreator energy term!");
        ...
        for (Iterator atoms = protein.atoms().iterator(); atoms.hasNext();) {
            ...
            if (! atom.nowhere()) {
                ...
                try {
                    ...
                    System.out.println("Problem in RapdfCreator.createEnergyTerm while processing atomOne number :"+number+"\n"+atom);
                    throw ex;
                }
            }
        }
