 ...
 * @author amilev
 *
 * This class is an energy element for an Hydrogen Bond. Two atoms are involved: Hydrogen atomOne (hAtom,
...
// following fields of the variable pair is need for the unit hydrogenBondsPairs
   ...
   public String toString() {
       if ((oAtom == null) & (hAtom == null)) return "HydrogenBondEnergyElement: - atoms not setResidue yet";
