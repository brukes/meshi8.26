...
public class ExcludedVolParametersList extends ArrayList<ExcludedVolParameters> {
    ...
    public Parameters parameters(Object obj) {
        ...
        return parameters(largeType.ordinal(), smallType.ordinal());
    }
    public ExcludedVolParameters parameters(int largeType, int smallType) {
        try {
            return get(largeType * (largeType + 1) / 2 + smallType);
        }
        catch (Exception e) {
