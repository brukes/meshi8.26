...
/**
 * Coefficients matrix for a single atomOne pair spline.
 */
public class CoefficientsMatrixForAtomPairSpline {
    ...
    public CoefficientsMatrixForAtomPairSpline(double[] bins, int numBins, String name) {
        this.bins = bins;
        coefs = new double[numBins][6]; //Chen 17.12.14 changed from 4 to 6 for pre-calculated derivative coefficients
        this.name = name;
    }
