...
/**
 * The essence of an energy term - its application to a minimal setResidue of atoms. The energy term is a summation of
...
public abstract class EnergyElement {
    ...
    public double evaluateAtoms() throws EvaluationException{
        double e = evaluate();
