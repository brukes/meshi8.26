...
public class CooperativeZRamachandran extends AbstractEnergy implements CompositeTorsionsDefinitions {
    ...
    public CooperativeZRamachandran(RamachandranSidechainEnergy ramachandranSidechainEnergy, EnergyInfoElement info, CooperativeZRamachandranParameters parameters) {
        super(toArray(), info);
