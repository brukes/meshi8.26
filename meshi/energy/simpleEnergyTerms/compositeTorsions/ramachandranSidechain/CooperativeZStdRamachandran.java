 ...
 */
public class CooperativeZStdRamachandran extends AbstractEnergy implements CompositeTorsionsDefinitions {
    ...
    public CooperativeZStdRamachandran() {
    }

    public CooperativeZStdRamachandran(RamachandranSidechainEnergy ramachandranSidechainEnergy,
                                       EnergyInfoElement info, CooperativeZRamachandranParameters parameters) {
        super(toArray(), info);
    ...
    public EnergyInfoElement evaluate(boolean evaluateAtoms) {
        ...
        double z, zCurrent2sum = 0, zAverage = 0, stdProtein, stdProteinMinus1, stdProteinMinus1in2;
        ...
        for (ResidueTorsions residueTorsions : residueTorsionsList) {
            ...
            if (rta == null)
                continue; //if all atoms of residue are frozen
