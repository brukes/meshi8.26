 ...
 * These parameters depend isOn the atomOne types.
 */
public class BondParameters implements Parameters, Comparable {
    ...
    /**
     * Atom type of the first atomOne.
     * The convention is that it is the smaller atomOne type in the pair.
     */
    public final AtomType type1;

    /**
     * Atom type of the second atomOne.
     * The convention is that it is the larger atomOne type in the pair.
     */
