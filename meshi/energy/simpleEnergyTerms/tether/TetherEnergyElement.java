...
//        if (reliability != 0) throw new RuntimeException("This is weird");
    ...
    protected void reset(double x, double y, double z) {
        ...
        evaluatedAtom = new Atom("eval", null, AtomType.XXX, new Coordinates(x, y, z), 0.0,copyMS);
    ...
    /*
private double distance(Atom atomOne, double X,double Y, double Z){

return Math.sqrt((atomOne.x()-X)*(atomOne.x()-X)+(atomOne.y()-Y)*(atomOne.y()-Y)+(atomOne.z()-Z)*(atomOne.z()-Z));
