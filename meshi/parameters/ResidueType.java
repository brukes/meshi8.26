...
public enum ResidueType {
    ALA("ALA","A",AtomType.AH,AtomType.AN,AtomType.ACA,AtomType.AC,AtomType.AO,AtomType.ACB,true,null,true),     //0
	...
	PHE("PHE","F",AtomType.FH,AtomType.FN,AtomType.FCA,AtomType.FC,AtomType.FO,AtomType.FCB,true,null,true), //4
	GLY("GLY","G",AtomType.GH,AtomType.GN,AtomType.GCA,AtomType.GC,AtomType.GO,null        ,true), //5
	HIS("HIS","H",AtomType.HH,AtomType.HN,AtomType.HCA,AtomType.HC,AtomType.HO,AtomType.HCB,true,null,true), //6
	ILE("ILE","I",AtomType.IH,AtomType.IN,AtomType.ICA,AtomType.IC,AtomType.IO,AtomType.ICB,true,null,true), //7
	LYS("LYS","K",AtomType.KH,AtomType.KN,AtomType.KCA,AtomType.KC,AtomType.KO,AtomType.KCB,true), //8
	LEU("LEU","L",AtomType.LH,AtomType.LN,AtomType.LCA,AtomType.LC,AtomType.LO,AtomType.LCB,true,null,true), //9
	MET("MET","M",AtomType.MH,AtomType.MN,AtomType.MCA,AtomType.MC,AtomType.MO,AtomType.MCB,true,"MSE",true), //10
	...
	VAL("VAL","V",AtomType.VH,AtomType.VN,AtomType.VCA,AtomType.VC,AtomType.VO,AtomType.VCB,true,null,true),
	TRP("TRP","W",AtomType.WH,AtomType.WN,AtomType.WCA,AtomType.WC,AtomType.WO,AtomType.WCB,true,null,true),
	TYR("TYR","Y",AtomType.YH,AtomType.YN,AtomType.YCA,AtomType.YC,AtomType.YO,AtomType.YCB,true,null,true),
    ...
    private ResidueType(String nameThreeLetters, String nameOneLetter,
        ...
        this(nameThreeLetters, nameOneLetter,
			hType, nType, caType,
			cType, oType, cbType, standard,null,false);
    }
    private ResidueType(String nameThreeLetters, String nameOneLetter,
			AtomType hType, AtomType nType, AtomType caType, 
			AtomType cType, AtomType oType, AtomType cbType, boolean standard,
            String alternativeName,boolean isHydrophobic) {
