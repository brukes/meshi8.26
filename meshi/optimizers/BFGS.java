 ...
 * H(1,1:n) followed by H(2,2:n) followed by H(3,3:n) and so isOn until H(n,n).
 * <p/>
 ...
 * unrealiable, by having huge numbers in the H entries. This paramter sets a upper limit isOn the
 ...
 * might occur at the start due to atomOne clashes.
...
public class BFGS extends Minimizer {
    ...
    private static final double DEFAULT_INIT_STEP_STEEPEST_DECENT = 0.0000001;
    ...
    public BFGS(TotalEnergy energy,
                ...
                double stepSizeReductionSteepestDecent, double stepSizeExpansionSteepestDecent) throws UpdateableException {
