...
public class Trp extends ResidueExtendedAtoms {
    ...
    public Trp(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.WCG, atomList, this,molecularSystem));
        atoms.add(CD1 = getAtom("CD1", AtomType.WCD1, atomList, this,molecularSystem));
        atoms.add(NE1 = getAtom("NE1", AtomType.WNE, atomList, this,molecularSystem));
        atoms.add(HE1 = getAtom("HE1", AtomType.WHE, atomList, this,molecularSystem));
        atoms.add(CD2 = getAtom("CD2", AtomType.WCD2, atomList, this,molecularSystem));
        atoms.add(CE2 = getAtom("CE2", AtomType.WCE2, atomList, this,molecularSystem));
        atoms.add(CE3 = getAtom("CE3", AtomType.WCE3, atomList, this,molecularSystem));

        atoms.add(CZ3 = getAtom("CZ3", AtomType.WCZ3, atomList, this,molecularSystem));
        atoms.add(CH2 = getAtom("CH2", AtomType.WCH2, atomList, this,molecularSystem));
        atoms.add(CZ2 = getAtom("CZ2", AtomType.WCZ2, atomList, this,molecularSystem));
