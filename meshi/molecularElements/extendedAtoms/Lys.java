...
public class Lys extends ResidueExtendedAtoms {
    ...
    public Lys(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.KCG, atomList, this,molecularSystem));
        atoms.add(CD = getAtom("CD", AtomType.KCD, atomList, this,molecularSystem));
        atoms.add(CE = getAtom("CE", AtomType.KCE, atomList, this,molecularSystem));
        atoms.add(NZ = getAtom("NZ", AtomType.KNZ, atomList, this,molecularSystem));
