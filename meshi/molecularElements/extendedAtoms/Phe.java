...
public class Phe extends ResidueExtendedAtoms {
    ...
    public Phe(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.FCG, atomList, this,molecularSystem));
        atoms.add(CD1 = getAtom("CD1", AtomType.FCD, atomList, this,molecularSystem));
        atoms.add(CE1 = getAtom("CE1", AtomType.FCE, atomList, this,molecularSystem));
        atoms.add(CZ = getAtom("CZ", AtomType.FCZ, atomList, this,molecularSystem));
        atoms.add(CD2 = getAtom("CD2", AtomType.FCD, atomList, this,molecularSystem));
        atoms.add(CE2 = getAtom("CE2", AtomType.FCE, atomList, this,molecularSystem));
