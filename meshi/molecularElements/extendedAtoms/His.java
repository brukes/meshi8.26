...
public class His extends ResidueExtendedAtoms {
    ...
    public His(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.HCG, atomList, this,molecularSystem));
        atoms.add(ND1 = getAtom("ND1", AtomType.HND, atomList, this,molecularSystem));
        atoms.add(HD1 = getAtom("HD1", AtomType.HHD, atomList, this,molecularSystem));
        atoms.add(CE1 = getAtom("CE1", AtomType.HCE, atomList, this,molecularSystem));
        atoms.add(NE2 = getAtom("NE2", AtomType.HNE, atomList, this,molecularSystem));
        atoms.add(HE2 = getAtom("HE2", AtomType.HHE, atomList, this,molecularSystem));
        atoms.add(CD2 = getAtom("CD2", AtomType.HCD, atomList, this,molecularSystem));
    ...
    public void addHydrogens(BondParametersList bondParametersList, AngleParametersList angleParametersList) {
        ...
        try {
            ...
            HD1.resetCoordinates();
            HE2.resetCoordinates();
        }
    }
}
