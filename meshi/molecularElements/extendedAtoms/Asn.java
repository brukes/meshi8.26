...
public class Asn extends ResidueExtendedAtoms {
    ...
    public Asn(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.NCG, atomList, this,molecularSystem));
        atoms.add(ND2 = getAtom("ND2", AtomType.NND, atomList, this,molecularSystem));
        atoms.add(HD21 = getAtom("HD21", AtomType.NHD1, atomList, this,molecularSystem));
        atoms.add(HD22 = getAtom("HD22", AtomType.NHD2, atomList, this,molecularSystem));
        atoms.add(OD1 = getAtom("OD1", AtomType.NOD, atomList, this,molecularSystem));
