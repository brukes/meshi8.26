...
public class Glu extends ResidueExtendedAtoms {
    ...
    public Glu(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.ECG, atomList, this,molecularSystem));
        atoms.add(CD = getAtom("CD", AtomType.ECD, atomList, this,molecularSystem));
        atoms.add(OE1 = getAtom("OE1", AtomType.EOE, atomList, this,molecularSystem));
        atoms.add(OE2 = getAtom("OE2", AtomType.EOE, atomList, this,molecularSystem));
