...
public class Leu extends ResidueExtendedAtoms {
    ...
    public Leu(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.LCG, atomList, this,molecularSystem));
        atoms.add(CD1 = getAtom("CD1", AtomType.LCD1, atomList, this,molecularSystem));
        atoms.add(CD2 = getAtom("CD2", AtomType.LCD2, atomList, this,molecularSystem));
