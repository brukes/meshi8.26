...
public class Arg extends ResidueExtendedAtoms {
    ...
    public Arg(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.RCG, atomList, this,molecularSystem));
        atoms.add(CD = getAtom("CD", AtomType.RCD, atomList, this,molecularSystem));
        atoms.add(NE = getAtom("NE", AtomType.RNE, atomList, this,molecularSystem));
        atoms.add(HE = getAtom("HE", AtomType.RHE, atomList, this,molecularSystem));
        atoms.add(CZ = getAtom("CZ", AtomType.RCZ, atomList, this,molecularSystem));
        atoms.add(NH1 = getAtom("NH1", AtomType.RNH, atomList, this,molecularSystem));
        atoms.add(NH2 = getAtom("NH2", AtomType.RNH, atomList, this,molecularSystem));
