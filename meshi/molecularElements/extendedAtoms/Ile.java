...
public class Ile extends ResidueExtendedAtoms {
    ...
    public Ile(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG1 = getAtom("CG1", AtomType.ICG1, atomList, this,molecularSystem));
        atoms.add(CD1 = getAtom("CD1", AtomType.ICD, atomList, this,molecularSystem));
        atoms.add(CG2 = getAtom("CG2", AtomType.ICG2, atomList, this,molecularSystem));
