...
public class Gln extends ResidueExtendedAtoms {
    ...
    public Gln(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.QCG, atomList, this,molecularSystem));
        atoms.add(CD = getAtom("CD", AtomType.QCD, atomList, this,molecularSystem));
        atoms.add(NE2 = getAtom("NE2", AtomType.QNE, atomList, this,molecularSystem));
        atoms.add(HE21 = getAtom("HE21", AtomType.QHE1, atomList, this,molecularSystem));
        atoms.add(HE22 = getAtom("HE22", AtomType.QHE2, atomList, this, molecularSystem));
        atoms.add(OE1 = getAtom("OE1", AtomType.QOE, atomList, this,molecularSystem));
