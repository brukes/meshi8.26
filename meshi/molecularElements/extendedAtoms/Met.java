...
public class Met extends ResidueExtendedAtoms {
    ...
    public Met(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.MCG, atomList, this,molecularSystem));
        atoms.add(SD = getAtom("SD", AtomType.MSD, atomList, this,molecularSystem));
        atoms.add(CE = getAtom("CE", AtomType.MCE, atomList, this,molecularSystem));
