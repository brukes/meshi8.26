...
public class Asp extends ResidueExtendedAtoms {
    ...
    public Asp(AtomList atomList, ResidueIdentifier id, ResidueMode mode,MolecularSystem molecularSystem) {
        ...
        atoms.add(CG = getAtom("CG", AtomType.DCG, atomList, this,molecularSystem));
        atoms.add(OD1 = getAtom("OD1", AtomType.DOD, atomList, this,molecularSystem));
        atoms.add(OD2 = getAtom("OD2", AtomType.DOD, atomList, this,molecularSystem));
