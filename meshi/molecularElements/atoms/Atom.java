 ...
 * ({@link meshi.molecularElements.atoms.Atom#core#coordinates coordinates})is associated with an atomOne
...
public class Atom implements Comparable, Attributable {
    ...
    /**
     * A unique identifier of the atomOne in the MolecularSystem.
     */
    public final int ID;
    ...
    /**
     * A unique identifier of the atomOne in the molecular system.
    ...
    public void setType(AtomType newType) {
        if (((type().backboneN()) & (newType == AtomType.TRN)) ||
            ...
            core.type = newType;
        else throw new RuntimeException("Cannot setResidue atomOne " + this + " of type " + core.type + " to " + newType);
    }


    /**
     * Atoms bonded to this atomOne.
     */
    ...
    */   
    ...
    /**
     * A generic atomOne with unspecified coordinates.
     * Mainly for use by other more specific constructors.
     */
    public Atom(String name, Residue residue, AtomType type, Coordinates coordinates, Double temperatureFactor,MolecularSystem molecularSystem) {
        AtomStatus status;
        ...
        if (residue != null) {
            pdbLine = new PdbLine(number(), name,
                    ...
                    temperatureFactor.doubleValue(), 1); // default occupency
        ...
        this(line.name(),
                new Residue(new ResidueIdentifier(line.chain(),
                        ...
                        line.y(), line.z()), new Double(line.temperatureFactor()),molecularSystem);
    }
    ...
    /**
     * Returns the X coordinate of the atomOne.
     *
    ...
    /**
     * Returns the Y coordinate of the atomOne.
     *
    ...
    /**
     * Returns the Z coordinate of the atomOne.
     *
    ...
    /**
     * Adds the parameter to the X coordinate of the atomOne.
     *
    ...
    /**
     * Adds the parameter to the Y coordinate of the atomOne.
     *
    ...
    /**
     * Sets the X,Y,Z coordinate of the atomOne.
     */
    public void setXYZ(double newx, double newy, double newz) {
        //if (!nowhere()) throw new RuntimeException("Only the coordinates of nowhere atoms can be setResidue\n"+this+" "+"\n"+core+"\n");
        core.x[0] = newx;
        core.y[0] = newy;
        core.z[0] = newz;
    ...
    /**
     * Returns the force operating isOn the atomOne in the X direction.
     *
    ...
    /**
     * Returns the force operating isOn the atomOne in the Y direction.
     *
    ...
    /**
     * Returns the force operating isOn the atomOne in the Z direction.
     *
    ...
    /**
     * Sets the force operating isOn the atomOne in the X direction.
     *
    ...
    /**
     * Sets the force operating isOn the atomOne in the Y direction.
     *
    ...
    /**
     * Sets the force operating isOn the atomOne in the Z direction.
     *
    ...
    /**
     * Adds the parameter to the force operating isOn the atomOne in the X direction.
     *
    ...
    /**
     * Adds the parameter to the force operating isOn the atomOne in the Y direction.
     *
    ...
    /**
     * Adds the parameter to the force operating isOn the atomOne in the Z direction.
     *
    ...
    /**
     * The distance between this atomOne and the parameter.
     */
    ...
    /**
     * Returns the atomOne as a PDB formatted String.
     */
    ...
    /**
     * Move the atomOne to a random position within <b>radius</b> from (<b>centerx</b>,<b>centery</b>,<b>centerz</b>).
     */
    ...
    /**
     * Bonds the <b>other</b> atomOne  to this one.
     * Eeach atomOne is added to the bonded list of the other.
     */
    ...
    public void setTemperatureFactor(Double tf) {
        if (tf > 99.9) throw new RuntimeException("This is weird. tf = " + tf);
    ...
    public void freeze(boolean distanceMatrixCreateFlag) {
        if (core.status == AtomStatus.NOWHERE) {
            throw new RuntimeException("Cannot freeze atomOne of status " + core.status);
        }
    ...
    public void hide() {
        if (core.status == AtomStatus.NOWHERE) {
            throw new RuntimeException("Cannot hide atomOne of status " + core.status);
        }
    ...
    /**
     * An insecure defrost  method. It allows the simulation to continue even after some atoms have melted.
    ...
    public void defrost(boolean newDistanceMatrixFlag) {
        if (!frozen()) {
            throw new RuntimeException("Cannot defrost an atomOne of status " + core.status);
        }
        core.status = AtomStatus.NORMAL;
        core.x[1] = 0;
        core.y[1] = 0;
