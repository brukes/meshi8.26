...
public class SequenceAlignment extends ArrayList<SequenceAlignmentColumn> {
    ...
    public static SequenceAlignment identityAlignment(MeshiSequence sequence1, MeshiSequence sequence2) {
        return substitutionAlignment(sequence1,sequence2,new IdentityMatrix());
    }

    public static SequenceAlignment substitutionAlignment(MeshiSequence sequence1, MeshiSequence sequence2,
    		SubstitutionMatrix substitutionMatrix) {//name updated by Tommer 9.914, throws added 11.9.14
        ...
        DpMatrix matrix = new DpMatrix(sequence1, sequence2, new SubstitutionScorer(substitutionMatrix));//Edited by Tommer 1.9.14, gap penalty was -0.2
