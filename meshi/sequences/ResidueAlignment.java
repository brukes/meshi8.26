...
public class ResidueAlignment extends ArrayList<ResidueAlignmentColumn> {
    ...
    public ResidueAlignment(Chain chain1, String name1,//is this constructor needed?? Tommer 24.9.14
        ...
        if (alignmentMethod == ResidueAlignmentMethod.IDENTITY) {
            SequenceAlignment sa = SequenceAlignment.substitutionAlignment(sequence1, sequence2, substitutionMatrix);//substitutionMatrix is not initialized here. Tommer 24.9.14
            //signature changed Tommer 1.9.14
            try {//Added by Tommer 1.9.14
				output=new MeshiWriter("..\\work\\workOut\\sequences.txt");
				output.print(sa);
				output.close();
				System.out.println("printed to file ..\\work\\workOut\\sequences.txt\n");
			} catch (IOException e) {
    ...
    public ResidueAlignment(ResidueSequence residueSequence0, ResidueSequence residueSequence1) {
        this(SequenceAlignment.substitutionAlignment(residueSequence0, residueSequence1, new IdentityMatrix()));//Tommer 2.9.14
    }
    ...
    public ResidueAlignment(ResidueSequence residueSequence0, ResidueSequence residueSequence1, SubstitutionMatrix substitutionMatrix) {
        this(SequenceAlignment.substitutionAlignment(residueSequence0, residueSequence1, substitutionMatrix));//Tommer 2.9.14
    }
    ...
    public ResidueAlignment(Chain chain0, Chain chain1, SequenceList sequenceList, SubstitutionMatrix substitutionMatrix) {
        ...
        SequenceAlignment sequence0Alignment = SequenceAlignment.substitutionAlignment(sequence0, sequence0FromSL, substitutionMatrix);
        SequenceAlignment sequence1Alignment = SequenceAlignment.substitutionAlignment(sequence1, sequence1FromSL, substitutionMatrix);
