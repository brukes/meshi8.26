...
public class MeshiSequence extends SequenceAlignment {
    ...
    public MeshiSequence renumber(MeshiSequence reference, AlignmentScheme alSchem) {//Tommer 23.9.14
        SequenceAlignment alignment = SequenceAlignment.substitutionAlignment(reference, this, alSchem);
    ...
    public static SequenceAlignment stringAlignment(String sequence1, String sequence2, AlignmentScheme alSchem){//Tommer 24.9.14
    	MeshiSequence meshiSequence1=new MeshiSequence(sequence1, "first sequence");
    	MeshiSequence meshiSequence2=new MeshiSequence(sequence2, "second sequence");
    	SubstitutionScorer scorer=new SubstitutionScorer(alSchem);
    	DpMatrix dpMatrix=new DpMatrix(meshiSequence1,meshiSequence2,scorer);
    	SequenceAlignment sa=dpMatrix.backTrack();
		//System.out.print(sa);
		return sa;
