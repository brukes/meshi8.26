...
public class ConservationContactsRatio extends AbstractEnergy {
    ...
    private DoubleInfoElement 	contactsInfo;
    private DoubleInfoElement 	rgRatioInfo;
    ...
    public ConservationContactsRatio(AtomList atomList, EnergyInfoElement info, boolean fileFound) {
        ...
        mRadius = 8;
        atoms = atomList;
        contactsInfo = new DoubleInfoElement(InfoType.CONTACTS11,"Average number of CA contacts (8A from a CA of a residue that is more than 10 residues away");
        rgRatioInfo = new DoubleInfoElement(InfoType.CONSERVATION_RG_RATIO,"The ratio between the RGs of conserved CAs and all CAs");
