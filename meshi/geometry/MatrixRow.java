...
//                            "Distance mirrors and free distances have nothing to do here\n" + distance);
    ...
    public String toString() {
        String out = "MatrixRow atomOne = " + atomOne + " number = " + atomOneNumber + "\n";
        ...
        for (AtomCore cellAtom : cell) {
            ...
            if (d2 < rMaxPlusBuffer2) {
                if (atomOneNumber >cellAtomNumber) {
                    ...
                    if (atomOneNumber <cellAtomNumber) {
//                        if ((atomOneNumber == 16) && (cellAtomNumber == 828))
//                            System.out.println("xxxxxxxxxxx--------------- " + new FreeDistance(cellAtom.atom, atomOne.atom));
    ...
    private void insert(AtomCore cellAtom,
        ...
        AtomCore atom2;
        found = false;
//        if ((atomOne.number == 828) && (cellAtom.number == 16))
