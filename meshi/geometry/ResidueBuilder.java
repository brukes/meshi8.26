...
public class ResidueBuilder {
    ...
    protected static void getAtom_xyza(double[] xyza, double bond, double angle, double chi, Atom A1, Atom A2, Atom A3) {
        if (A1 == null)
            throw new RuntimeException("Missing atomOne 1 in the torsion construction");
        if (A2 == null)
            throw new RuntimeException("Missing atomOne 2 in the torsion construction");
        if (A3 == null)
            throw new RuntimeException("Missing atomOne 3 in the torsion construction");
    ...
    /**
     * Returns the specified atomOne from a residue.
     */
