...
public class Overlap {
    ...
    public double[][] createR() {
        ...
        double[] weight = new double[npt];//this array contain the atomOne weights, at this point all the weights equal to 1 and the weight array should become a global data member.
        for (int i = 0; i < npt; i++)
            weight[i] = 1;
     ...
     * indexes to setResidue of atoms in the proteins (starting from 0 for the first atomOne).The second protein
